...
exports.deploy = async function() {
    ...
    const NestStakingTrade = await ethers.getContractFactory('NestStakingTrade');

    console.log('** Deploy: bsc_test@20230310.js **');
    
    // ** Deploy: bsc_test@20230310.js **
    ...
    // nestStakingTrade: 0x84b48d4F9c7B783A1c8be3514396149b3C52015A
    ...
    // const nestStakingTrade  = await NestStakingTrade.deploy(
    //     nest.address,
    //     usdt.address,
    //     30000000000000000n,
    //     200
    // );
    const nestStakingTrade = await NestStakingTrade.attach('0x84b48d4F9c7B783A1c8be3514396149b3C52015A');
    console.log('nestStakingTrade: ' + nestStakingTrade.address);

    //await nestStakingTrade.initialize(nestGovernance.address);
    //await usdt.approve(nestStakingTrade.address, 10000000000000000000000000n);
    //await usdt.transfer((await ethers.getSigners())[0].address, 100000000000000000000000n);
    await nest.transfer(nestStakingTrade.address, 100000000000000000000000n);
