...
exports.deploy = async function() {
    ...
    console.log('** Deploy: bsc_test@20230201.js **');
    ...
    const nestCraft = await NestCraft.attach('0x1F51245Ec0cb1D40E4F27373FD180B6157DA44Cd');
    console.log('nestCraft: ' + nestCraft.address);

    // const newNestCraft = await NestCraft.deploy();
    // console.log('newNestCraft: ' + newNestCraft.address);
