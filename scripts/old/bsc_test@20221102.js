...
exports.deploy = async function() {
    ...
    console.log('** Deploy: bsc_test@20221102.js **');
    
    // ** Deploy: bsc_test@20221102.js **
    ...
    // nestCyberInk: 0x18f5A122A00062F11e0801650875D1B5285a7E44
    // nestNFTAuction: 0xBA9bf3C085ACAfd8B1446Be222ACBB5F80D94e9d
    // proxyAdmin: 0x43D2c8141E792D391A64F7140E708Ba05962C71A
    // nestMarket: 0x29273DA72049F999ED917bDe2bDFf02bA614B4cA
    ...
    const nestCyberInk = await NestCyberInk.attach('0x18f5A122A00062F11e0801650875D1B5285a7E44');
    ...
    const nestNFTAuction = await NestNFTAuction.attach('0xBA9bf3C085ACAfd8B1446Be222ACBB5F80D94e9d');
    ...
    const nestMarket = await NestMarket.attach('0x29273DA72049F999ED917bDe2bDFf02bA614B4cA');
    console.log('nestMarket: ' + nestMarket.address);

    // console.log('9. nestMarket.update()');
