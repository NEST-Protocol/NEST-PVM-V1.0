...
exports.deploy = async function() {
    ...
    console.log('** Deploy: bsc_test@20230224.js **');
    ...
    // nestTrustFutures_new: 0x573e166aAEEFb1baE40653351330cE29cc5E1434
    ...
    const nestTrustFutures_new = await NestTrustFutures.attach('0x573e166aAEEFb1baE40653351330cE29cc5E1434');
    console.log('nestTrustFutures_new: ' + nestTrustFutures_new.address);
    ...
    // await nestTrustFutures_new.update(nestGovernance.address);

    // await nestTrustFutures_new.openChannel(0);
    // await nestTrustFutures_new.openChannel(1);
    // await nestTrustFutures_new.openChannel(2);

    // await nestVault.approve(nestTrustFutures_new.address, 100000000000000000000000000n);
    // await nest.approve(nestTrustFutures_new.address, 100000000000000000000000000n);
    ...
    */
    ...
    const contracts = {
        ...
        nestVault: nestVault,
        nestTrustFutures: nestTrustFutures_new,
