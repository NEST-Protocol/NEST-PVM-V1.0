...
describe('HedgeOptions', function() {
    it('First', async function() {
        ...
        const BLOCK = 100000;
        await hedgeOptions.open(hbtc.address, toBigInt(2450, USDT_DECIMALS), true, BLOCK, toBigInt(1000), {
            value: toBigInt(0.01)
        });
        ...
        // await hedgeOptions.open(hbtc.address, '47215470000', true, BLOCK, toBigInt(100000), {
        //     value: toBigInt(0.02)
        // });
