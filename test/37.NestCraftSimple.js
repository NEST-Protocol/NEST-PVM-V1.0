...
describe('37.NestCraftSimple', function() {
    it('First', async function() {
        ...
        //await listAccounts();
        await nest.mintTo(owner.address, 100000000000000000000000000n);
        ...
        let receipt = await nestCraft.directPost(200, [
            toBigInt(1.508461),
            toBigInt(66666666666),
            toBigInt(2000 / 20000)
        ]);

        receipt = await nestCraft.directPost(200, [
            toBigInt(1.508461 * 2),
        ...
        let c = await nestCraft.estimate('m1(0)');

        console.log('result=' + toDecimal(c).toString());

        if (true) {
            console.log('1. buy');
            let receipt = await nestCraft.buy('1*m1(0)');
