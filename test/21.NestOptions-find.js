...
describe('21.NestOptions-find', function() {
    it('First', async function() {
        ...
        if (false) {
            ...
            await nestOptions.setConfig(eth.address, {
                sigmaSQ: '99999999',
                miu: '88888',
                minPeriod: '77777'
            });
        ...
        if (true) {
            ...
            for (var i = toBigInt(2450, USDT_DECIMALS) / 3n; i < toBigInt(2450, USDT_DECIMALS) * 3n; ) {
                ...
                await nestOptions.open(eth.address, i, true, BLOCK, toBigInt(1000), {
                    value: toBigInt(0.01)
                });
                //let fot = await nestOptions.getOptionInfo(eth.address, i, true, BLOCK);
                let fot = { index: j++ };
        ...
        if (true) {
            ...
            for (var i = toBigInt(2650, USDT_DECIMALS); i < toBigInt(2450, USDT_DECIMALS) * 5n; ) {
                ...
                await nestOptions.open(eth.address, i, false, BLOCK, toBigInt(1000), {
                    value: toBigInt(0.01)
                });
                // let fot = await nestOptions.getOptionInfo(eth.address, i, false, BLOCK);
                let fot = { index: j++ };
                console.log('fot: ' + toDecimal(await nestOptions.balanceOf(fot.index, owner.address)));
        ...
        if (false) {
            ...
            for (var i = 40000000000 / 3; i < 40000000000 * 2; ) {
                i = Math.floor(i);
                console.log('call, price:' + i);
                await nestOptions.open(hbtc.address, i, true, BLOCK, toBigInt(100000), {
                    value: toBigInt(0.02)
                });
                ...
                expect(Math.abs(parseFloat(toDecimal(await nestOptions.balanceOf(fot.index, owner.address))) - cal)).to.lt(0.001);
        ...
        if (false) {
            ...
            for (var i = 38000000000; i < 40000000000 * 5; ) {
                i = Math.floor(i);
                console.log('put, price:' + i);
                await nestOptions.open(hbtc.address, i, false, BLOCK, toBigInt(100000), {
                    value: toBigInt(0.02)
                });
                ...
                expect(Math.abs(parseFloat(toDecimal(await nestOptions.balanceOf(fot.index, owner.address))) - put)).to.lt(0.002);
        ...
        if (false) {
            ...
            for (var i = 38000000000; i < 40000000000 * 5; ) {
                ...
                expect(Math.abs(parseFloat(toDecimal(await nestOptions.balanceOf(fot.index, owner.address))) - put)).to.lt(0.0001);
