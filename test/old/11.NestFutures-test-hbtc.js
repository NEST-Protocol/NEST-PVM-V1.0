...
describe('11.NestFutures-test-hbtc', function() {
    it('First', async function() {
        var [owner, addr1, addr2] = await ethers.getSigners();
        
        const { eth, usdt, hbtc, nest, nestOptions, nestFutures, nestPriceFacade, nestVault,
        ...
        const queryPrice = async function(tokenAddress, enlarge) {
            ...
            let k = await nestFutures._calcRevisedK(
                pi.triggeredSigmaSQ, 
                pi.prices[3],
                pi.prices[2],
                pi.prices[1],
